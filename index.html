   ...
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
       ...
       <h5 class="logo-text">GEO Dashboard</h5>
     </a>
   </div>
   ...
   <ul class="sidebar-menu">
      ...
      <li class="active">
		...
		<ul class="sidebar-submenu">
		  <li class="active"><a class="active" href="index.html"><i class="zmdi zmdi-dot-circle-alt"></i> Geo</a></li>
		</ul>
      </li>
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <div class="media-body">
            <h6 class="mt-2 user-title">Rais Manasiya</h6>
            <p class="user-subtitle">rais@example.com</p>
            </div>
           </div>
          </a>
        </li>
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><i class="icon-wallet mr-2"></i> My Account</li>
        <li class="dropdown-divider"></li>
  ...
  <div class="content-wrapper">
	...
	<div class="row">
     <div class="col-12 col-lg-12 col-xl-12">
	    <div class="card">
		 <div class="card-header">Indonesia Geo Data
		  
		 </div>
		 <div class="card-body" style="padding:4px;">
		    
			<div class="chart-container-1" id="map" style="min-height:512px;width: 100%;">
	...
	<footer class="footer">
      <div class="container">
        <div class="text-center">
          Copyright © 2020 GEO Dashboard Admin
        </div>
      </div>
    </footer>
	<!--End footer-->
